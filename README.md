...
### DEVELOPMENT:
- Merging and optimizting, of scripts in ".\scripts\", overall scripts should be reduced to as few as as possible...Merging was done...Optimization was done...now merging optimized files. Predicted 10 scripts or less in ".\scripts".
